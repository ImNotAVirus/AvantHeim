defmodule ElvenPackets.Server.EntityPackets do
  ...
  import ElvenEnums.PlayerEnums, only: [morph: 1, morph_design: 1]
  import ElvenPackets.Enums.SayEnums, only: [color_type: 1]

  alias ElvenPackets.Types.{NsEnum, NsInteger, NsList, NsString, NsBoolean}
  ...
  defpacket "c_mode", as: CMode do
    ...
    field :morph_design, NsEnum, values: morph_design(:__enumerators__)
  ...
  defpacket "st", as: St do
    ...
    field :hp, NsInteger
    field :mp, NsInteger
    field :buffs, :list, type: NsInteger, default: :drop, joiner: " "
  end
end
