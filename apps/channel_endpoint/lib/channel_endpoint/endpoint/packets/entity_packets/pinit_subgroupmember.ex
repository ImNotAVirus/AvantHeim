defmodule ChannelEndpoint.Endpoint.EntityPacket.Pinit.SubGroupMember do
  ...
  @enforce_keys [:entity_type, :entity_id, :group_position, :level, :name, :unknow, :gender, :race, :morph, :hero_level]
  ...
  def parse(bin, opts) do
    ...
    case String.split(bin, sep, parts: 3) do
      [entity_type, entity_id, group_position, level, name, unknow, gender, race, morph, hero_level, rest] -> {:ok, to_struct(entity_type, entity_id, group_position, level, name, unknow, gender, race, morph, hero_level), rest}
      [entity_type, entity_id, group_position, level, name, unknow, gender, race, morph, hero_level] -> {:ok, to_struct(entity_type, entity_id, group_position, level, name, unknow, gender, race, morph, hero_level), ""}
      _ -> :error
    end
  end
    ...
    defp to_struct(entity_type, entity_id, group_position, level, name, unknow, gender, race, morph, hero_level) do
      %SubGroupMember{
