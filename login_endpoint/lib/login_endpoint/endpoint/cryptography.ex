defmodule LoginEndpoint.Endpoint.Cryptography do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> LoginEndpoint.Endpoint.Cryptography.encrypt("fail Hello. This is a basic test")  
  ...
  ## Examples
    ...
    iex> LoginEndpoint.Endpoint.Cryptography.decrypt_pass("2EB6A196E4B60D96A9267E")  
    "admin"
    iex> LoginEndpoint.Endpoint.Cryptography.decrypt_pass("1BE97B527A306B597A2")  
    "user"
  """
