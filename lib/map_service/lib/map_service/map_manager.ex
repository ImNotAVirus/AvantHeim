defmodule MapService.MapManager do
  ...
  @spec start_static_map(atom, non_neg_integer) :: {:ok, map_config()}
  ...
  def init(opts) do
    ...
    loader_config = Application.get_env(:map_service, :loader_config, [])
    ...
    children = [
      ...
      {MapLoader, [name: loader(name), config: loader_config]}
    ]
