defmodule ElvenAlgorithms.PlayerAlgorithms do
  ...
  @base_damage_constant %{
    ...
    swordman:
      List.flatten([
        [10, 11, 13, 15, 17, 19, 20, 22, 24, 26, 28, 29, 31, 33],
        [35, 37, 38, 40, 42, 44, 46, 47, 49, 51, 53, 55, 56, 58],
        [60, 62, 64, 65, 67, 69, 71, 73, 74, 76, 78, 80, 82, 83],
        [85, 87, 89, 91, 92, 94, 96, 98, 100, 101, 103, 105, 107],
        [109, 110, 112, 114, 116, 118, 119, 121, 123, 125, 127, 128],
        [130, 132, 134, 136, 137, 139, 141, 143, 145, 146, 148, 150],
        [152, 154, 155, 157, 159, 161, 163, 164, 166, 168, 170, 172],
        [173, 175, 177, 179, 181, 182, 184, 186]
      ]),
    archer:
      List.flatten([
        [60, 61, 63, 64, 66, 67, 69, 71, 72, 74, 76, 77, 79, 80, 82],
        [83, 85, 87, 88, 90, 92, 93, 95, 96, 98, 99, 101, 103, 104],
        [106, 108, 109, 111, 112, 114, 115, 117, 119, 120, 122, 124],
        [125, 127, 128, 130, 131, 133, 135, 136, 138, 140, 141, 143],
        [144, 146, 147, 149, 151, 152, 154, 156, 157, 159, 160, 162],
        [163, 165, 167, 168, 170, 172, 173, 175, 176, 178, 179, 181],
        [183, 184, 186, 188, 189, 191, 192, 194, 195, 197, 199, 200],
        [202, 204, 205, 207, 208, 210, 211, 213, 215, 216]
      ]),
    magician:
      List.flatten([
        [10, 11, 13, 15, 17, 19, 20, 22, 24, 26, 28, 29, 31, 33, 35],
        [37, 38, 40, 42, 44, 46, 47, 49, 51, 53, 55, 56, 58, 60, 62],
        [64, 65, 67, 69, 71, 73, 74, 76, 78, 80, 82, 83, 85, 87, 89],
        [91, 92, 94, 96, 98, 100, 101, 103, 105, 107, 109, 110, 112],
        [114, 116, 118, 119, 121, 123, 125, 127, 128, 130, 132, 134],
        [136, 137, 139, 141, 143, 145, 146, 148, 150, 152, 154, 155],
        [157, 159, 161, 163, 164, 166, 168, 170, 172, 173, 175, 177],
        [179, 181, 182, 184, 186]
      ]),
    martial_artist:
      List.flatten([
        ...
        [55, 56, 58, 59, 61, 62, 64, 65, 67, 68, 70, 71, 73, 74, 76],
        ...
        [136, 137, 139, 140, 142, 143, 145, 146, 148, 149, 151, 152],
        [154, 155, 157]
      ])
  }
  ...
  @secondary_damage_constant %{
    ...
    archer:
      List.flatten([
        [10, 11, 12, 13, 15, 16, 17, 19, 20, 21, 22, 24, 25, 26],
        [28, 29, 30, 32, 33, 34, 35, 37, 38, 39, 41, 42, 43, 45],
        [46, 47, 48, 50, 51, 52, 54, 55, 56, 58, 59, 60, 61, 63],
        [64, 65, 67, 68, 69, 71, 72, 73, 74, 76, 77, 78, 80, 81],
        [82, 84, 85, 86, 87, 89, 90, 91, 93, 94, 95, 97, 98, 99],
        [100, 102, 103, 104, 106, 107, 108, 110, 111, 112, 113],
    ...
    martial_artist:
      List.flatten([
        [30, 31, 32, 33, 35, 36, 37, 39, 40, 41, 42, 44, 45, 46],
        [48, 49, 50, 52, 53, 54, 55, 57, 58, 59, 61, 62, 63, 65],
        [66, 67, 68, 70, 71, 72, 74, 75, 76, 78, 79, 80, 81, 83],
        [84, 85, 87, 88, 89, 91, 92, 93, 94, 96, 97, 98, 100, 101],
        [102, 104, 105, 106, 107, 109, 110, 111, 113, 114, 115, 117],
        [118, 119, 120, 122, 123, 124, 126, 127, 128, 130, 131, 132],
        [133, 135, 136, 137, 139, 140, 141, 143, 144, 145, 146, 148],
        [149, 150, 152, 153, 154, 156, 157]
      ])
  }
